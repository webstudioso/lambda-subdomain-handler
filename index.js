...
exports.handler =  (event, context, callback) => {
    ...
    // Set in CF origin
    const serverAppId = request.origin.s3.customHeaders['x-provider-app-id'][0].value;
    const serverUrl = request.origin.s3.customHeaders['x-provider-server-url'][0].value;
    const defaultTemplate = request.origin.s3.customHeaders['x-dappify-default-template'][0].value;
    console.log(`Origin custom headers appId=${serverAppId} serverUrl=${serverUrl} defaultTemplate=${defaultTemplate}`);
